...
def main():
    print("Clickbait Hendline Generator")
    print()

    print("Our website needs to trick people into looking at!")
    while True:
        print("Enter the number of clickbait headline to generate:")
        response = input("> ")
    ...
    for i in range(numberOfHeadlines):
        ...
        if clickbaitType == 1:
            ...
            headline = enerateWhatYouDontKnowHeadline()
...
def generateAreMillennialsKillingHeadline():
    ...
    return f"Are Millennias Killing the {noun} Industry?"


def enerateWhatYouDontKnowHeadline():
    noun = random.choice(NOUNS)
...
def generateReasonsWhyHeadline():
    ...
    return f'{number1} Reasons Why {pluralNoun} Are More Interesting Than ' \
           f'You Think (Number {number2} Will Surprise You!)'
