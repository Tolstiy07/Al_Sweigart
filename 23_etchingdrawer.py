...
while True:
    ...
    print("WASD keys o move, H for help, C to clear, "
          + 'F to save, or QUIT.')
    ...
    if response == 'QUIT':
        ...
        print('Enter W, A, S and D charactes to move the cursor and')
        print('draw a line behind it as it moves. For example, ddd')
        print('draws a ine going right and sssdddwwwaaa draws a box')
        print()
